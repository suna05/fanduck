...
//  console.log(Calendar.getDay()); // 2017년 7월 1일은 토요일이므로 숫자 '6'이 출력된다.
  // template calendar
  html += '<div class="prevBtn" style="float:left; margin-left:10%; color:white; cursor:pointer">prev</div>';
  html += '<div class="nextBtn" style="float:right; margin-right:10%; color:white; cursor:pointer">next</div>';
