  ...
  console.log(mno)
    $.getJSON('http://192.168.0.69:8080/auth/userinfo.json', function(result) {
       if (result.data) {
           ...
           $.get('http://192.168.0.69:8080/movieperson/list.json', { 'mno' : mno }, function(result) {
             ...
             for (var j = 0 ; j < list.length; j++) {
               $.ajax('http://www.kobis.or.kr/kobisopenapi/webservice/rest/people/searchPeopleInfo.json?' +
                      'key=2f866d0aa55c6fd70be5b68ea8dc1ce5&peopleCd=' + moviepeople[j].mpCode, {
                       ...
                       success: function(getPersonDetail) {
                                 ...
                                 $.get('http://192.168.0.69:8080/castmember/listone.json',
                                  {
                                   'mno' : mno,
                                         ...
                                         $.ajax('http://www.kobis.or.kr/kobisopenapi/webservice/rest/movie/searchMovieInfo.json?' +
                                                'key=b0cac97aa508433ca9835e54ab51d7cd&movieCd=' + attendMovieCode, {
                                                 ...
                                                 success: function(getMovieDetail) {
                                                           ...
                                                           $.get('http://192.168.0.69:8080/movie/list.json', function(result) {
                                                           ...
                                                           $.post('http://192.168.0.69:8080/castmember/updatemovie.json',
                                                           {
                                                             mvNo : movieCodeArr[0],
                                                             mno : mno,
                                                             fpCode : peopleCd
