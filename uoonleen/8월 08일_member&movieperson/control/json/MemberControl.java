  ...
  public Object upload1(Member member, MultipartFile[] files) throws Exception {
    ...
    if (files != null) {
	    for (int i = 0; i < files.length; i++) {
	      files[i].transferTo(new File(ctx.getRealPath("/web/movieperson/photo/" + files[i].getOriginalFilename())));
	      System.out.println(ctx.getRealPath("/web/movieperson/photo/" + files[i].getOriginalFilename()));
	      ...
	      member.setPath("photo/" + files[i].getOriginalFilename());
