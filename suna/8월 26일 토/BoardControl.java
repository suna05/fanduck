...
public class BoardControl {
  ...
  @RequestMapping("add")
  public Object add(Board board, @RequestParam(value="mpNo") int mpN, MultipartFile files) throws Exception {
    ...
    Thumbnails.of(file).size(450, 450).outputFormat("png").toFile(thumbnail); 
    ...
    board.setBdPhoto("photo/" + newFilename + "_400.png");
...
public HashMap<String, Object> list5(MultipartFile[] files) throws Exception {
  ...
  for (int i = 0; i < files.length; i++) {
    ...
    String newFile5= this.getNewFile5();
...
public HashMap<String, Object> list6(MultipartFile[] files) throws Exception {
  ...
  for (int i = 0; i < files.length; i++) {
    ...
    String newFile6= this.getNewFile6();
