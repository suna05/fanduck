...
public class MoviePersonServiceImpl implements MoviePersonService {
  ...
  public List<MoviePerson> list(int mno) throws Exception {
    HashMap<String,Object> valueMap = new HashMap<>();
    valueMap.put("mno", mno);
    return moviePersonDao.selectList(valueMap);
  }

  public MoviePerson get(int mno, int mpNo) throws Exception {
    HashMap<String,Object> valueMap = new HashMap<>();
    valueMap.put("mno", mno);
    valueMap.put("mpNo", mpNo);
    
    return moviePersonDao.selectOne(valueMap);
  }
  ...
  public void update(MoviePerson moviePerson) throws Exception {
	  moviePersonDao.update(moviePerson);
  } 

  @Override
  public void remove(MoviePerson moviePerson) throws Exception {
	moviePersonDao.delete(moviePerson);
  }
