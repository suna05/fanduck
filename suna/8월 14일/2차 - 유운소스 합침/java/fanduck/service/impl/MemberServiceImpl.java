...
public class MemberServiceImpl implements MemberService {
  ...
  @Override
  public void updateOutPass(Member member) throws Exception {
     memberDao.updateOutPass(member);
     System.out.println("마지막이예요");
  }

  @Override
  public void updateOnlyPath(Member member) throws Exception {
     memberDao.updateOnlyPath(member);
     System.out.println("마지막이예요");
  }
